...
{
	return [[[TFVAppInfo sharedInstance] bundlePath] stringByAppendingPathComponent:fileName];
}

+(NSString *)documentsPath:(NSString *)fileName
{
	return [[[TFVAppInfo sharedInstance] docmentsPath] stringByAppendingPathComponent:fileName];
}

+(NSString *)cachesPath:(NSString *)fileName
{
    return [[[TFVAppInfo sharedInstance] cachesPath] stringByAppendingPathComponent:fileName];
}
...
{
    return [[[TFVAppInfo sharedInstance] preferencesPath] stringByAppendingPathComponent:fileName];
}
...
+(BOOL)saveYUV420PDataToFile:(NSString*)filename
                ...
                withLinesize:(int[3])linesize
                       ...
                       withH:(int)h
{
#define kDebugYUV420PDirPath [[TFVAppInfo sharedInstance] homePath]
